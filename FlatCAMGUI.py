...
class FlatCAMGUI(QMainWindow):
    ...
    def __init__(self, version, name=None):
        ...
        # New
        self.menufilenew = QAction(QIcon('share/file16.png'), '&New project', self)
        self.menufile.addAction(self.menufilenew)

        # Recent
        self.recent = self.menufile.addMenu(QIcon('share/folder16.png'), "Open recent ...")
        ...
        # Open Excellon ...
        self.menufileopenexcellon = QAction(QIcon('share/folder16.png'), 'Open &Excellon ...', self)
        self.menufile.addAction(self.menufileopenexcellon)

        # Open G-Code ...
        self.menufileopengcode = QAction(QIcon('share/folder16.png'), 'Open G-&Code ...', self)
        ...
        # Import SVG ...
        self.menufileimportsvg = QAction(QIcon('share/folder16.png'), 'Import &SVG ...', self)
        self.menufile.addAction(self.menufileimportsvg)

        # Export SVG ...
        self.menufileexportsvg = QAction(QIcon('share/folder16.png'), 'Export &SVG ...', self)
        ...
        # Save Project As ...
        self.menufilesaveprojectas = QAction(QIcon('share/floppy16.png'), 'Save Project &As ...', self)
        self.menufile.addAction(self.menufilesaveprojectas)

        # Save Project Copy ...
        self.menufilesaveprojectcopy = QAction(QIcon('share/floppy16.png'), 'Save Project C&opy ...', self)
        self.menufile.addAction(self.menufilesaveprojectcopy)

        # Save Defaults
        self.menufilesavedefaults = QAction(QIcon('share/floppy16.png'), 'Save &Defaults', self)
        ...
        # Quit
        self.exit_action = QAction(QIcon('share/power16.png'), '&Exit', self)
        ...
        self.menuoptions_transfer = self.menuoptions.addMenu(QIcon('share/transfer.png'), 'Transfer options')
        ...
        self.open_gerber_btn = self.toolbarfile.addAction(QIcon('share/flatcam_icon32.png'), "Open &Gerber")
        self.open_exc_btn = self.toolbarfile.addAction(QIcon('share/drill32.png'), "Open &Excellon")
        self.open_gcode_btn = self.toolbarfile.addAction(QIcon('share/cnc32.png'), "Open Gco&de")
        self.save_btn = self.toolbarfile.addAction(QIcon('share/floppy32.png'), 'Save Project &As ...')
        ...
        self.newgeo_btn = self.toolbareditobj.addAction(QIcon('share/new_geo32.png'), "New Blank Geometry")
        self.editgeo_btn = self.toolbareditobj.addAction(QIcon('share/edit32.png'), "Edit Geometry")
        self.updategeo_btn = self.toolbareditobj.addAction(QIcon('share/edit_ok32.png'), "Update Geometry")
        self.updategeo_btn.setEnabled(False)

        self.toolbaredit = QToolBar('Edit Toolbar')
        self.addToolBar(self.toolbaredit)
        self.delete_btn = self.toolbaredit.addAction(QIcon('share/delete32.png'), "&Delete")
        ...
        self.measure_btn = self.toolbartools.addAction(QIcon('share/measure32.png'), "&Measurement Tool")
